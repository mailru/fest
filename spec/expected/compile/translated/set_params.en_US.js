;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/set_params.en_US']=function(__fest_context) {
    "use strict";
    ...
    __fest_buf = "";
    __fest_blocks.one = function(params) {
        var __fest_buf = "";
        __fest_buf += ("|");
        try {
            params.text2 = params.text;
        } catch (e) {
            __fest_log_error(e.message);
        }
        try {
            __fest_buf += (__fest_escapeHTML(params.text2))
        } catch (e) {
