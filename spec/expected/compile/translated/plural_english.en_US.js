;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/plural_english.en_US']=function(__fest_context) {
    "use strict";
    ...
    __fest_params = [];
    __fest_params = ["one ruble", "%s rubles"];
