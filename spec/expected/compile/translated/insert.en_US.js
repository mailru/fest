;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/insert.en_US']=function(__fest_context) {
    "use strict";
    ...
    __fest_buf += ("<style>.foo{ont: 18px\/18px \"Helvetica Neue\", Arial;}\n.bar{\\\"\\\"}</style><script>var include_script = true + \'\\\"\';\n</script>");
