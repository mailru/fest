;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/block_unsuspected_recursion.en_US']=function(__fest_context) {
    "use strict";
    ...
    __fest_blocks.main = function(params) {
        var __fest_buf = "";
        try {
            counter++
        } catch (e) {
