;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/xss.en_US']=function(__fest_context) {
    "use strict";
    ...
    __fest_buf += ("<script>document.write(\'\u003Cscript id=\"");
    try {
        __fest_buf += (__fest_escapeJS(json.xss))
    } catch (e) {
