;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/cdata.en_US']=function(__fest_context) {
    "use strict";
    ...
    __fest_buf += ("<script><![CDATA[alert (\"2\" \u003C 3);]]></script>");
