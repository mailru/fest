;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/block_with_include.en_US']=function(__fest_context) {
    "use strict";
    ...
    __fest_blocks.inner = function(params) {
        var __fest_buf = "";
        __fest_buf += ("inner");
        return __fest_buf;
    };
    __fest_blocks.outer = function(params) {
        var __fest_buf = "";
