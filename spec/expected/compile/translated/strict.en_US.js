;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/strict.en_US']=function(__fest_context) {
    "use strict";
    ...
    try {
        json.not_strict = true;
    } catch (e) {
        __fest_log_error(e.message);
    }
    try {
        g = true;
        json.not_strict = false;
    } catch (e) {
        __fest_log_error(e.message);
    }
    try {
        __fest_buf += (__fest_escapeHTML(json.not_strict))
    } catch (e) {
