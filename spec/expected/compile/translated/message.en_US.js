;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/message.en_US']=function(__fest_context) {
    "use strict";
    ...
    var __fest_plural = function anonymous(n) {
            return n != 1 ? 1 : 0;
        };
    ...
    __fest_buf += ("<a href=\"#\">");
    try {
        __fest_attrs[0] = __fest_escapeHTML(json.name)
    } catch (e) {
        __fest_attrs[0] = "";
        __fest_log_error(e.message);
    }
    __fest_buf += ("<img src=\"favicon.png\" alt=\"Logo of " + __fest_attrs[0] + "\"/></a>Row\n\t\n\t\tLine with a<a href=\"#\" title=\"123\">link</a>RowСтрока");
    try {
        __fest_buf += (__fest_escapeHTML(n))
    } catch (e) {
    ...
    __fest_params = [];
    __fest_params = ["рубль", "рубля", "рублей"];
    __fest_buf += (__fest_format(__fest_params[__fest_plural(__fest_select)], __fest_select));
