;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/useless_set_select.en_US']=function(__fest_context) {
    "use strict";
    ...
    __fest_buf = "";
    __fest_blocks.foo = function(params) {
        var __fest_buf = "";
        __fest_buf += ("foo");
        return __fest_buf;
    };
    ...
    if (__fest_if) {
        __fest_blocks.baz = function(params) {
            var __fest_buf = "";
            __fest_buf += ("baz");
            return __fest_buf;
        };
        ...
        if (__fest_if) {
            __fest_blocks.qux = function(params) {
                var __fest_buf = "";
                __fest_buf += ("qux");
                return __fest_buf;
            };
