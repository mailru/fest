;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/script.en_US']=function(__fest_context) {
    "use strict";
    ...
    __fest_buf += ("\"");
    try {
        __fest_buf += (__fest_escapeHTML(json.script))
    } catch (e) {
    ...
    __fest_buf += ("\"");
    try {
        __fest_buf += (__fest_escapeHTML(include_script))
    } catch (e) {
