;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/message']=function(__fest_context) {
    "use strict";
    ...
    __fest_buf += ("<img src=\"favicon.png\" alt=\"Логотип " + __fest_attrs[0] + "\"/></a>Строка\n\t\n\t\tСтрока со<a href=\"#\" title=\"123\">ссылкой</a>СтрокаСтрока");
    try {
