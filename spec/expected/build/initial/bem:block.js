;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['bem:block']=function(__fest_context) {
    "use strict";
    ...
    __fest_buf += ("<div bem:block=\"btn\"><bem:mod name=\"icon\" test=\"params.icon\"></bem:mod><span bem:elem=\"text\"><bem:mod name=\"pad\" has-block-mod=\"icon\"></bem:mod>");
    try {
        __fest_buf += (__fest_escapeHTML(params.text))
    } catch (e) {
        __fest_log_error(e.message + "9");
    }
    __fest_buf += ("</span></div><bem:btn>{ text: \"foo\" }</bem:btn><bem:btn>{ text: \"bar\", icon: true }</bem:btn>");
