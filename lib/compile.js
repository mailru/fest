        ...
        parser.onopentag = function (node) {
            ...
            switch (node.local){
                case 'element':
                    ...
                    fn[fn.length - 1] += 'try{__fest_elementName=' + _getAttr(node, 'name', 'expr') + ';';
                ...
                case 'get':
                    ...
                    fn[fn.length - 1] += 'return function(){return ("' + escapeJS(_getAttr(node, 'name')) + '" in __fest_blocks) ? __fest_blocks' + getName(_getAttr(node, 'name')) + '.call(__fest_self,' + context_name + ', params) : [];};';
                    fn[fn.length - 1] += '};';
