var compile = (function(){
    ...
    var sax = (new Function(fs.readFileSync(__dirname + '/sax.js').toString() + ' return sax;'))();
    var js_beautify = (new Function(fs.readFileSync(__dirname + '/beautify.js').toString() + ' return js_beautify;'))();
