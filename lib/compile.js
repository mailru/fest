		...
		function build_template(output) {
			...
			template =
				'function ' + name + '(__fest_context){' +
					...
					'if(typeof __fest_error === "undefined"){___fest_log_error = (console && console.error) ? function(){return Function.prototype.apply.call(console.error, console, arguments)} : function(){};}else{___fest_log_error=__fest_error};' +
