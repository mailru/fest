        ...
        parser.onopentag = function (node) {
            ...
            switch (node.local){
                case 'element':
                    ...
                    fn[fn.length - 1] += 'if(typeof __fest_elementName !== "string"){__fest_elementName="' + _getAttr(node, 'default') + '"}';
                    fn[fn.length - 1] += '}catch(e){__fest_elementName="' + _getAttr(node, 'default') + '";__fest_log_error(e.message);}';
                ...
                case 'get':
                    ...
                    fn[fn.length - 1] += 'return function(){return ("' + _getAttr(node, 'name') + '" in __fest_blocks) ? __fest_blocks' + getName(_getAttr(node, 'name')) + '.call(__fest_self,' + context_name + ', params) : [];};';
                    fn[fn.length - 1] += '};';
