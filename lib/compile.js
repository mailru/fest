var compile = (function(){
    ...
    var readFileSync = typeof __read_file === 'function' ? __read_file : fs.readFileSync;
    if (path !== null){
    ...
    var sax = new Function(readFileSync(__dirname + '/sax-js.js', 'utf-8') + '; return sax')();
        ...
        parser.onopentag = function (node) {
            ...
            switch (node.local){
                ...
                case 'script':
                    ...
                    return;
                case 'insert':
                    fn[fn.length - 1] += '__fest_str += "' + readFileSync(dirname(file) + '/' + node.attributes.src.value, 'utf-8').replace(/\n/g, '\\n') + '";';
                    return;
                case 'for':
