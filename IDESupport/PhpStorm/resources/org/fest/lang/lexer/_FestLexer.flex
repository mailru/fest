...
FEST_NAME=({ALPHA}|"_")({ALPHA}|{DIGIT}|"_"|"."|"-")*
...
<DOCTYPE> "'"[^']*"'" { return XmlTokenType.XML_ATTRIBUTE_VALUE_TOKEN;}
<DOCTYPE> "["(([^\]\"]*)|(\"[^\"]*\"))*"]" { return XmlElementType.XML_MARKUP;}
...
<YYINITIAL> "<fest:" { yybegin(FEST_TAG); return FestTokenType.XML_START_TAG_START; }
<FEST_TAG> {FEST_NAME} { yybegin(ATTR_LIST); pushState(FEST_TAG); return FestTokenType.XML_NAME; }
<FEST_TAG> "/>" { yybegin(YYINITIAL); return FestTokenType.XML_EMPTY_ELEMENT_END; }
<FEST_TAG> ">" { yybegin(YYINITIAL); return FestTokenType.XML_TAG_END; }
...
<YYINITIAL> "</fest:" { yybegin(FEST_END_TAG); return FestTokenType.XML_END_TAG_START; }
<FEST_END_TAG> {FEST_NAME} { return FestTokenType.XML_NAME; }
<FEST_END_TAG> ">" { yybegin(YYINITIAL); return FestTokenType.XML_TAG_END; }
...
<ATTR_LIST,ATTR,FEST_TAG,FEST_END_TAG,TAG,END_TAG,DOCTYPE> {S} { return XmlTokenType.XML_WHITE_SPACE; }
